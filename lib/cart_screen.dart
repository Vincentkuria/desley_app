...
class _CartState extends State<Cart> {
  ...
  void _getCartItems() async {
    final dio1 = Dio();
    data = null;
    dio1.options.baseUrl = 'http://165.22.123.187';
  ...
  void _removeCart(item, currentCount) async {
    final dio2 = Dio();
    dio2.options.baseUrl = 'http://165.22.123.187';
  ...
  void _addCart(item, currentCount) async {
    final dio3 = Dio();
    dio3.options.baseUrl = 'http://165.22.123.187';
  ...
  void deletCartItem(item) async {
    final dio4 = Dio();
    dio4.options.baseUrl = 'http://165.22.123.187';
  ...
  void sendPayment() async {
    int paymentId;
    var dio5 = Dio();
    dio5.options.baseUrl = 'http://165.22.123.187';
